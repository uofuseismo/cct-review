#ifndef CCT_SERVICE_SERVER_HPP
#define CCT_SERVICE_SERVER_HPP
                               ...
                               const boost::beast::http::verb)> &callback)
{
    ...
    auto optionsHandler = [&request]()
    {
        ...
        result.set(boost::beast::http::field::access_control_allow_headers, //"Access-Control-Allow-Headers",
        ...
        request.method() == boost::beast::http::verb::get)
    {
        ...
        catch (const CCTService::InvalidPermissionException &e)
        {
            return forbidden(e.what());
        }
        catch (const CCTService::UnimplementedException &e)
        {
